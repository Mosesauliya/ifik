...
class Footer_model extends CI_Model {
    ...
    private function _ensure_tables()
    {
        ...
        if (!$existing) {
            ...
            $this->db->insert('footer_settings', $default_settings);
        }
    }

    /**
     * Ambil data setting footer saat ini dari database
     * @return object
     */
    ...
    public function update_settings($data)
    {
        ...
        if ($existing) {
            $this->db->where('id', 1);
            $this->db->update('footer_settings', $data);
            return true;
        } else {
            $data['id'] = 1;
            $this->db->insert('footer_settings', $data);
            return true;
        }
    }
