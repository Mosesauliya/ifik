...
<head>
    ...
    <style>
        ...
        .nav-item:has(.nav-link-login) {
            margin-left: auto;  /* mendorong item login ke paling kanan */
        }
        ...
        @media (max-width: 992px) {
            ...
            .nav-link-login { padding: 6px; }  /* lebih kecil */
            .nav-link-login span:last-child { display: none; }  /* sembunyikan teks */
