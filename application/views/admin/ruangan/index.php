...
<body>
        ...
        <div class="modal-card">
            ...
            <form id="formRuangan" onsubmit="handleFormSubmit(event)" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <!-- Section 2: Upload Files (Foto & 3D Model .glb/.fbx) -->
                    <div class="form-grid-2">
                        <div class="upload-field-box">
                            <label style="font-size:0.78rem; font-weight:800; color:#334155; text-transform:uppercase;">📷 Foto Utama Ruangan</label>
                            <input type="file" id="inputFoto" name="foto" accept="image/png, image/jpeg, image/webp" class="form-input" style="padding:5px;">
                            <span class="hint">Format: JPG, PNG, WEBP (Max 5MB)</span>
                            <div id="previewFotoBox" style="display:none; margin-top:8px; align-items:center; gap:8px; background:#f8fafc; padding:6px 10px; border-radius:8px; border:1px solid #e2e8f0;">
                                <img id="previewFotoImg" src="" style="width:36px; height:36px; border-radius:6px; object-fit:cover; border:1px solid #cbd5e1;">
                                <span id="previewFotoText" style="font-size:0.75rem; color:#334155; font-weight:600; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; max-width:200px;"></span>
                            </div>
                        </div>
                        <div class="upload-field-box">
                            <label style="font-size:0.78rem; font-weight:800; color:#ea580c; text-transform:uppercase;">🧊 3D Model Ruangan (.GLB / .FBX)</label>
                            <input type="file" id="inputModel3D" name="model_3d" accept=".glb, .fbx, .gltf, .obj" class="form-input" style="padding:5px;">
                            <span class="hint">Format: .GLB atau .FBX (Max 50MB)</span>
                            <div id="previewModelBox" style="display:none; margin-top:8px; align-items:center; gap:6px; background:#fff7ed; padding:6px 10px; border-radius:8px; border:1px solid #ffedd5;">
                                <span style="font-size:0.85rem;">🧊</span>
                                <span id="previewModelText" style="font-size:0.75rem; color:#ea580c; font-weight:700;"></span>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function openModalTambah() {
            ...
            document.getElementById('previewFotoBox').style.display = 'none';
            document.getElementById('previewModelBox').style.display = 'none';
        ...
        function openModalEdit(data) {
            ...
            if (data.foto) {
                ...
                document.getElementById('previewFotoText').innerText = `Foto Terpasang: ${data.foto.split('/').pop()}`;
            } else {
                document.getElementById('previewFotoBox').style.display = 'none';
            }
            ...
            if (data.model_3d) {
                ...
                document.getElementById('previewModelText').innerText = `Berkas 3D (${ext}): ${data.model_3d.split('/').pop()}`;
            } else {
                document.getElementById('previewModelBox').style.display = 'none';
            }
