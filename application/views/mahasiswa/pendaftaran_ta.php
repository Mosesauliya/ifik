        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 sm:h-18">
                ...
                <nav class="hidden md:flex items-center gap-1.5 p-1 bg-orange-50/80 rounded-xl border border-orange-200/70 relative" id="mainNav">
                    ...
                    <a href="<?= site_url('mahasiswa/pendaftaran_ta'); ?>" class="nav-link active-link relative z-10 font-semibold px-5 py-2 rounded-lg text-xs flex items-center gap-2 tracking-wide text-slate-700">
