...
|
*/
if (isset($_SERVER['HTTP_HOST']) && strpos($_SERVER['HTTP_HOST'], 'ifik.forzasoftwarehouse.com') !== false) {
    $config['base_url'] = 'https://ifik.forzasoftwarehouse.com/';
} else {
...
|
*/
$config['encryption_key'] = 'ifik_telekom_creative_industry_secret_key_2025';
